...
/***/ "./vendor/mutation-summary/index.ts":
/*!******************************************!*\
  !*** ./vendor/mutation-summary/index.ts ***!
  \******************************************/
...
var tree_mirror_1 = __webpack_require__(/*! ./util/tree-mirror */ "./vendor/mutation-summary/util/tree-mirror.ts");
Object.defineProperty(exports, "TreeMirrorClient", ({ enumerable: true, get: function () { return tree_mirror_1.TreeMirrorClient; } }));


/***/ }),

/***/ "./vendor/mutation-summary/src/mutation-summary.ts":
/*!*********************************************************!*\
  !*** ./vendor/mutation-summary/src/mutation-summary.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MutationSummary = exports.Summary = exports.NodeMap = void 0;
class NodeMap {
    constructor() {
        this.nodes = [];
        this.values = [];
...
class NodeChange {
    constructor(node, childList = false, attributes = false, characterData = false, oldParentNode = null, added = false, attributeOldValues = null, characterDataOldValue = null) {
        this.node = node;
...
class MutationProjection {
    ...
    getChanged(summary, selectors, characterDataOnly) {
        this.selectors = selectors;
    ...
    matchabilityChange(node) {
        ...
        const el = node;
        const matchChanges = this.selectors.map((selector) => {
...
class MutationSummary {
    ...
    static createObserverOptions(queries) {
...
/***/ "./vendor/mutation-summary/util/tree-mirror.ts":
/*!*****************************************************!*\
  !*** ./vendor/mutation-summary/util/tree-mirror.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TreeMirrorClient = exports.TreeMirror = void 0;
const mutation_summary_1 = __webpack_require__(/*! ../src/mutation-summary */ "./vendor/mutation-summary/src/mutation-summary.ts");
class TreeMirror {
...
class TreeMirrorClient {
    constructor(target, mirror, testingQueries = []) {
        ...
        this.mirror = mirror;
        this.nextId = 1;
        this.knownNodes = new mutation_summary_1.MutationSummary.NodeMap();
        ...
        this.mutationSummary = new mutation_summary_1.MutationSummary({
            rootNode: target,
            callback: (summaries) => {
    ...
    serializeAddedAndMoved(added, reparented, reordered) {
        ...
        const parentMap = new mutation_summary_1.MutationSummary.NodeMap();
        all.forEach((node) => {
            const parent = node.parentNode;
            let children = parentMap.get(parent);
            if (!children) {
                children = new mutation_summary_1.MutationSummary.NodeMap();
    ...
    serializeAttributeChanges(attributeChanged) {
        const map = new mutation_summary_1.MutationSummary.NodeMap();
...
const mutation_summary_1 = __webpack_require__(/*! ../vendor/mutation-summary */ "./vendor/mutation-summary/index.ts");
class Squeaky {
    constructor(siteId) {
        this.events = [];
        ...
        this.update = (value) => {
            ...
            const event = Object.assign(Object.assign({}, value), { time: now - this.startedAt, timestamp: now });
        ...
        this.onClick = (event) => {
            this.update({ type: 'click', selector: utils_1.Utils.getCssPath(event.target) });
        };
        this.onBlur = () => {
        ...
        this.onScroll = lodash_1.throttle(() => {
            this.update({ type: 'scroll', x: window.scrollX, y: window.scrollY });
        }, 50);
        this.onMouseMove = lodash_1.throttle((event) => {
    ...
    install() {
        this.client = new mutation_summary_1.TreeMirrorClient(document, {
            initialize: function (rootId, children) {
                console.log({ f: 'initialize', args: [rootId, children] });
            },
            applyChanged: function (removed, addedOrMoved, attributes, text) {
                console.log({ f: 'applyChanged', args: [removed, addedOrMoved, attributes, text] });
            }
        });
...
window.squeaky = __webpack_exports__;
/******/ })()
;